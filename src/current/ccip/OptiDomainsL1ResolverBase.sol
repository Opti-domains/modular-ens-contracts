...
contract OptiDomainsL1ResolverBase is EVMFetchTarget {
     ...
     */
    function getTarget(bytes memory name, uint256 offset) public view returns (bytes32 node, address target) {
